...
class BeautyTextfield extends StatefulWidget {
  ...
  final Color iconColor, backgroundColor, accentColor, textColor;
              ...
              children: <Widget>[
                Expanded(
                  ...
                  child: Icon(
                    ...
                    color: isFocus ? widget.backgroundColor : widget.iconColor,
                  ),
                ),
                Expanded(
                  flex: 5,
                  child: Container(
                    ...
                    child: TextField(
                      ...
                      style: TextStyle(
                        ...
                        letterSpacing: 2,
                        color:
                            isFocus ? widget.backgroundColor : widget.textColor,
                      ),
